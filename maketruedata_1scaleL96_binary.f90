...
program maketruedata_binary
    ...
    real(8) :: x1_true(kmax), x2_true(jmax*kmax)
    real(8) :: random_num
    integer :: random_index
    integer :: i, j, n, iostat, jmaxkmax
    integer :: Ampli, Freq
    ...
    open(iunit_t, file="1scale_t_truedata_fort_50span.bin", form='unformatted', access='stream', status="replace")

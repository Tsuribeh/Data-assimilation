...
program maketruedata_binary
    ...
    integer, parameter :: n_timesteps = data_span*4*365*100
    ...
    open(iunit_x1t, file="1scalePlusSine_xtrue_timeseries_km40_F8_50span.bin", &
    & form='unformatted', access='stream', status="replace")

    open(iunit_t, file="1scalePlusSine_t_truedata_fort_50span.bin", form='unformatted', access='stream', status="replace")
    ...
    do n = 1, n_timesteps
        ...
        call RK4(t, x1_true, dt, dble(1.0), dble(1.0))
